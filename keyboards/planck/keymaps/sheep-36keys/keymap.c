 ...
 */
    [_BASE] = LAYOUT_planck_grid(
     ...
     KC_NO, KC_NO, KC_NO, MOVE_TAB, KC_SPC, NUM_ESC, KC_ENT, KC_LSFT, GR_ESC, KC_NO,  KC_NO,   KC_NO
    ),
 ...
 */
    [_MOVE] = LAYOUT_planck_grid(
      _______, XXXXXXX, KC_PSCR, XXXXXXX, XXXXXXX, _______, _______, KC_PGUP, KC_HOME,   KC_UP,  KC_END, KC_BSPC,
      KC_LGUI, OSM(MOD_LALT), OSM(MOD_LSFT), OSM(MOD_LCTL), KC_CAPS, _______, _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL ,
      _______, _______, _______, _______, _______, _______, _______, KC_MRWD, KC_MPLY, KC_MNXT, KC_VOLD, KC_VOLU,
 ...
 */
    [_NUM] = LAYOUT_planck_grid(
      ...
      KC_F11, KC_F12, XXXXXXX, XXXXXXX, QK_BOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
